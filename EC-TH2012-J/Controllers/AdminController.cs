...
namespace WebNhaHangOnline.Controllers
{
    ...
    {
        [AuthLog(Roles = "Quản trị viên,Nhân viên,Nhân Viên Đơn Hàng")]
        // GET: Admin
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ThemSP([Bind(Include = "TenSP,LoaiSP,MaNCC,HangSX,XuatXu,GiaGoc,MoTa,SoLuong,isnew,ishot")] SanPham sanpham, HttpPostedFileBase ad, HttpPostedFileBase an, HttpPostedFileBase ak)
        {
            SanPhamModel spm = new SanPhamModel();
            if (ModelState.IsValid)
            {
