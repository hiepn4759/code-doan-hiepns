...
namespace BusinessLayer.Business.User
{
    public class UserModel
    {
        ...
        public AspNetUser FindById(string p)
        {
            return db.AspNetUsers.Find(p);
        }

        public void UpdateInfo(Models.EditInfoModel info, string id)
        {
        ...
        public IQueryable<AspNetUser> SearchUser(string key, string email, string hoten, string phone, string quyen)
        {
        ...
        public IQueryable<AspNetUser> SearchUserNV(string key, string email, string hoten, string phone, string quyen)
        {
        ...
        public IQueryable<AspNetUser> SearchUserAdmin(string key, string email, string hoten, string phone, string quyen)
        {
        ...
        public IQueryable<AspNetUser> SearchUserKH(string key, string email, string hoten, string phone,string quyen)
        {
        ...
        public IQueryable<AspNetRole> GetAllRole()
        {
            return db.AspNetRoles;
        }

        public void deleleallrole(string item, string quyen)
        {
        ...
        public bool ConfirmMail(string id)
        {
            AspNetUser user = new AspNetUser();
        ...
        public void SendMailConfirm(string p,string url)
        {
            ...
            if(us != null)
            {
                ...
                bo += "Xin cảm ơn.";
                sendmail.SendMail(new Models.EmailModel(mail, sub, bo));
            }
